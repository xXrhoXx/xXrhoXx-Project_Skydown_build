function createUnityInstance(t, n, d) {
    ...
    function D() {
        var t, e, n, s, r, o = performance.now(),
            ...
            a = (
                    T(t = "dataUrl"),
                    fetchChunkedData(function(e) {
                        T(t, e);
                    }).catch(function(e) {
                        var msg = "Failed to download chunked data";
                        if ("file:" == location.protocol)
                            c(msg + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error");
                        else
                            console.error(msg, e);
                    })
                );
